...
const PageHeader: React.FC<PageHeaderProps> = ({ title, description, icon: Icon, action }) => {
  return (
    <header className="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4 bg-base-100/40 backdrop-blur-md p-6 rounded-3xl border border-white/10 shadow-lg animate-in fade-in slide-in-from-top-4 duration-500">
